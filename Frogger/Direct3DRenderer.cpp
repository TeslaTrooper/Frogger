...
class Direct3DRenderer : public Direct3DWindow {
public:
	Direct3DRenderer(HINSTANCE hInstance);
	~Direct3DRenderer();
...
Direct3DRenderer::Direct3DRenderer(HINSTANCE hInstance) : Direct3DWindow(hInstance) {
...
void Direct3DRenderer::RenderBackground() {
	Drawable d = {
		Vec2(),
...
void Direct3DRenderer::Render(Drawable& d, Direct3DTexture* texture) {
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow) {
	Direct3DRenderer* app = new Direct3DRenderer(hInstance);
